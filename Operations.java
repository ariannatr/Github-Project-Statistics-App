...
public class Operations{
	...
	public void get_files_num(File directory) throws IOException
	{
	...
	public void get_lines(File directory,String dirname) throws IOException
	{
      	Integer total_num=0;
            Integer templines;
      	Process p=Runtime.getRuntime().exec("git ls-files ",null,directory);
      	...
      	System.out.println("Total num of lines "+total_num);
      	return;
	}
